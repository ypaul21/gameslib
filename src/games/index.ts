...
import { PalettoGame, IPalettoState } from "./paletto";
...
const games = new Map<string, typeof AmazonsGame | typeof BlamGame | typeof CannonGame |
                              ...
                              typeof TessellaGame | typeof PalettoGame
                >();
...
[
    ...
    StormCGame, PilastriGame, TessellaGame, PalettoGame,
].forEach((g) => {
...
export const GameFactory = (game: string, ...args: any[]): GameBase|GameBaseSimultaneous|undefined => {
    switch (game) {
        ...
        case "paletto":
            return new PalettoGame(args[0], ...args.slice(1));
    }
    return;
}
